  ...
  return (
    <footer className="footer  sticky  bottom-0 items-center p-4 bg-neutral text-neutral-content">
      <aside className="items-center grid-flow-col">
        ...
        <p>CsArquitectura Copyright © 2023 - All right reserved</p>
      </aside>
      <nav className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
        <a href="https://wa.me/+5493434677009">
          <img className="h-8" src={WhatsApp} alt="" />
        </a>
        <a href="https://www.instagram.com/fix.it77">
